...
The mobile Profile tab displays the avatar, name, activity counts, and account actions. Optional personal details are available in the edit screen. Edit profile opens a dedicated screen at /profile/edit for photo changes and optional details. Photo changes save immediately; Save profile saves the text fields. Photo updates preserve unsaved text in the edit form.
